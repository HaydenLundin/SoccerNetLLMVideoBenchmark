...
INPUT_PATTERN = f"{PROJECT_DIR}/partial_results_idefics2_vid{args.video_index}_gpu*.json"
OUTPUT_FILE = f"{PROJECT_DIR}/final_predictions_idefics2_video_{args.video_index}.json"
DEDUP_WINDOW = 3.0  # seconds

print(f"🔍 Merging Idefics2 results for Video Index {args.video_index}...")
