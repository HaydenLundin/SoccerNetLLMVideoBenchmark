...
INPUT_PATTERN = f"{PROJECT_DIR}/partial_results_phi3_vid{args.video_index}_gpu*.json"
OUTPUT_FILE = f"{PROJECT_DIR}/final_predictions_phi3_video_{args.video_index}.json"
DEDUP_WINDOW = 3.0  # seconds

print(f"🔍 Merging Phi-3.5-Vision results for Video Index {args.video_index}...")
