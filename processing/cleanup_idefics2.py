#!/usr/bin/env python3
"""
Cleanup Script for Incomplete Idefics2 Video Processing

Usage:
    python cleanup_idefics2.py --video_index 5
    python cleanup_idefics2.py --video_index 5 --dry-run
...
parser = argparse.ArgumentParser(description="Clean up incomplete Idefics2 video processing results")
...
print(f"🧹 Cleanup for Idefics2 Video Index {args.video_index}")
...
# File patterns
partial_pattern = os.path.join(PROJECT_DIR, f"partial_results_idefics2_vid{args.video_index}_gpu*.json")
merged_file = os.path.join(PROJECT_DIR, f"final_predictions_idefics2_video_{args.video_index}.json")
