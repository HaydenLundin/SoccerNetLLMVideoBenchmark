...
# ============================================================================
# CONFIGURATION - T4/GCLOUD OPTIMIZED
# ============================================================================
...
# T4 supports FP16 efficiently. Using nf4 for weights saves VRAM.
...
# 2. Load Phi-3.5-Vision model
# Optimization: Use 'sdpa' (Scaled Dot Product Attention) for faster inference on PyTorch 2.x
# This replaces the 'eager' implementation which was used for compatibility with older setups.
