...
FPS = 5.0             # 5 FPS for video understanding
WINDOW_SECONDS = 3.0   # 3s Window
...
print(f"🤖 [GPU {args.gpu_id}] Loading LLaVA-NeXT-Video 7B (BnB 4-bit)...")
...
while current_time < my_end_time:
    ...
    prompt = (
        ...
        f"Analyze this {WINDOW_SECONDS}s soccer clip showing {len(images)} frames. "
    ...
    # Process all frames as a video sequence
